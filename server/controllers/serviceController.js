...
const createService = async (req, res) => {
  try {
    ...
    if (!title || !slug || !excerpt || !description) {
      return res.status(400).json({
        success: false,

        message: "Title, slug, excerpt and description are required.",
      });
    }
...
const updateService = async (req, res) => {
  try {
    ...
    if (featuredImage !== undefined) {
      service.featuredImage = featuredImage;
    }
    ...
    if (isPublished !== undefined) {
      ...
      service.isPublished = published;

      // ==================================================
      // SET PUBLISHED DATE
      // ==================================================

      if (published && !service.publishedAt) {
